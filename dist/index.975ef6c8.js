...
var _taskJs = require("./modules/task.js");
const form = document.getElementById('task-form');
const taskInput = document.getElementById('task-input');
const taskList = document.getElementById('task-list');
document.addEventListener('DOMContentLoaded', (0, _taskJs.displayTasks));
form.addEventListener('submit', (e)=>{
    e.preventDefault();
    const task = taskInput.value;
    (0, _taskJs.addTask)(task);
    taskInput.value = '';
    (0, _taskJs.displayTasks)();
});

},{"./modules/task.js":"geYRh"}],"geYRh":[function(require,module,exports,__globalThis) {
